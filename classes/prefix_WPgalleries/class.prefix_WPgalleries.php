  ...
  ==================================================================================*/
    ...
    */
    ...
    function WPgalleries_register_cpt() {
      $labels = array(
          'name' => _e( $this->WPgalleries_cpt_label, 'WPgalleries' ),
      );
      $args = array(
          'labels' => $labels,
          'hierarchical' => true,
          'description' => _e( $this->WPgalleries_cpt_label, 'WPgalleries' ),
          'show_in_rest' => true,
    ...
    function WPgalleries_Metabox() {
      ...
      foreach( $WPgalleries_allow as $post_type ){
        add_meta_box(
            ...
            _e( $this->WPgalleries_cpt_label, 'WPgalleries' ),
    ...
    */
    ...
    function WPgalleries_selection($object) {
        ...
        echo '<div class="wrap" id="WPgalleries">';
          ...
          echo '<button class="wp-media ajax-action" data-action="WPgalleries">' . _e('Select images','WPgalleries') . '</button>';
